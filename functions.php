...
function minamaze_thinkup_child_frontscripts() {
	...
	wp_enqueue_style( 'minamaze-thinkup-style-godark', get_stylesheet_directory_uri() . '/style.css', array( 'thinkup-style' ), wp_get_theme()->get('Version') );
}
...
function minamaze_thinkup_updateoption_child_settings() {
	...
	$name_options_child = $name_theme_lower . '_thinkup_child_settings_godark';
	...
	if ( $options_child_settings != 1 ) {
		...
		$options_free['thinkup_styles_skin']        = 'godark';
